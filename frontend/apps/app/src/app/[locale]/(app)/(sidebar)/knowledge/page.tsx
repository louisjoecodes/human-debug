import { CreateKnowledgeChat } from "@/components/create-knowledge-chat";
import { CreateKnowledgeForm } from "@/components/forms/create-knowledge-form";
import { KnowledgeRefreshButton } from "@/components/knowledge/knowledge-refresh-button";

import { KnowledgeLoading } from "@/components/knowledge/knowledge.loading";
import { KnowledegServer } from "@/components/knowledge/knowledge.server";
import {
  Card,
  CardContent,
  CardFooter,
  ...
  return (
    <>
      <div className="p-4 sm:px-6 sm:py-0 mb-3">
        <h1 className="text-lg font-semibold md:text-2xl">Knowledge</h1>
      </div>
