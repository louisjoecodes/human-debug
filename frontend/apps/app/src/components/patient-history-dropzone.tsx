...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, DialogClose } from '@v1/ui/dialog';
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <ScrollArea className="h-[60vh]">
                                <pre className="whitespace-pre-wrap">{JSON.stringify(patientInfo)}</pre>
                            </ScrollArea>
                        </div>
                        <div>
                            <Card>
